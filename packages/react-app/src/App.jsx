  ...
  return (
    <div className="App">
      ...
      <div style={{ marginTop: 32, opacity: 0.5 }}>
        ...
        Created by <Address value={address} ensProvider={mainnetProvider} fontSize={16} blockExplorer={blockExplorer} />
      </div>

      <div style={{ marginTop: 32, opacity: 0.5 }}>
        <a target="_blank" style={{ padding: 32, color: "#000" }} href="https://github.com/wakii/defi-basic-dapp">
          🍴 @wakii/defi-basic-dapp
        </a>
      </div>
